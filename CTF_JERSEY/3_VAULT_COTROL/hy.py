check = [
    0x5C, 0xA3, 0x41, 0xAB, 0x64, 0xBA, 0xCF, 0xC3, 0xD0, 0x61, 
    0x1E, 0x18, 0x56, 0xA3, 0x2D, 0x1E, 
    # 0xF6, 0x93, 0x87, 0x58, 0x09, 0x16, 0x8C, 0x63, 0x8C, 0x43, 
    # 0x2B, 0x9E, 0x6D, 0x73, 0x7F, 0xC5
]
...
r10 = [
    ...
    # 0x0C, 0x7D, 0x8D, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 
...
xor = [
    0x69, 0x7C, 0x74, 0x22, 0x71, 0x49, 0x52, 0x59, 0x52, 0x7A, 
    0x77, 0x60, 0x6F, 0x6A, 0x54, 0x2D
]

xor_2 = [
    0x65, 0x3C, 0x26, 0x27, 0x34, 0x71, 0x78, 0x5B, 0x38, 0x24, 
    0x63, 0x73, 0x39, 0x76, 0x7D, 0x61
]

input = [
    0x74, 0x75, 0x6e, 0x67, 0x64, 0x76, 0x61, 0x6e, 0x64, 0x65,
    0x70, 0x74, 0x72, 0x61, 0x69, 0x63, 0x6f, 0x6d, 0x6f, 0x74,
    0x6b, 0x68, 0x6f, 0x6e, 0x67, 0x68, 0x61, 0x69, 0x6e, 0x68,
    0x61, 0x61
...
for i in range(4):
    for j in range(4): print(hex(ans[i + 4 * j]), end = " ")
    print()
...
print()
print(hex(0xd4 ^ 0xbf ^ 0xba ^ (0x60 ^ 0x30)))
